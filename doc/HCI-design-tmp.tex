...
\author{杨铭 - 5130379022\\
        李晟 - 5130379017\\
        张云翔 - 5130379012}
\title{HCI 课程选题提交\\\textbf{Musicube\\
...
\section{概况}
\paragraph{手势+节拍}
\paragraph{}Musicube是一款基于LeapMotion的音乐节拍游戏。通过LeapMotion（下文将详细介绍）对玩家的手部动作进行追踪，完成玩家在游戏内“魔方”上的各种操作，契合音乐节拍。
\begin{figure}[!h]
...
\paragraph{}
由于LeapMotion的限制，Musicube将是一款PC音乐游戏。
\newpage
\section{用户分析和需求}
\subsection{用户分析}
\paragraph{}
...
所以Musicube也顺应了游戏市场的方向。
\paragraph{是否愿意尝试Musicube类的游戏}
\paragraph{}
...
\paragraph{}
由于Musicube输入方式的特性，我们游戏的可玩性将集中在玩法上，即使不愿意花费太多时间提高技术的玩家，也能从Musicube中获得许多乐趣。
\subsection{同类产品}
\paragraph{}
分析完了用户，再从同类产品的角度分析一下Musicube的可行性。在介绍同类产品之前，先介绍一下音游的几个基本概念
\begin{description}
...
\textbf{比较}
\begin{description}
  \item[玩法] 较传统音游有所进步，但是输入方式仍有限制，需要在较大的屏幕甚至游戏厅的街机上玩。Musicube则只需带一个小巧的LeapMotion即可
  \item[内容] 官方提供乐曲和乐谱，玩家可以根据官方乐曲自制乐谱，内容有限。Musicube支持玩家自己输入乐曲自制谱面
\end{description}
\newpage
\paragraph{}
\textbf{Lovelive！}\\
...
\textbf{比较}
\begin{description}
  \item[玩法] 实质上仍旧是下落式，没有什么突破。但是学习了手机游戏的套路，增加了玩家游戏时间。Musicube在玩法上创新，它的地图编辑器也可以为玩家提供额外的乐趣
  \item[设定] 与其他音乐游戏不同，Lovelive！拥有完整的人物背景故事设定，丰富的人物和剧情为游戏增加了许多分数。Musicube不以设定作为最大卖点，这也是众多音乐游戏的选择
  \item[画面] 主要使用了动漫风格的画面和人物，Musicube则将使用简洁干净的扁平化风格，让画面显得更加炫酷和前卫
\end{description}
\paragraph{立体输入的Musicube}
...
Musicube正式应用了手势输入这个新元素的一款新时期的音游。很多玩家也很希望尝试新鲜的游戏方式，所以会很乐于尝试这款游戏。
...
\begin{itemize}
  ...
  \item 优化LeapMotion的手势输入识别，让玩家更畅快地玩Musicube
\end{itemize}
\paragraph{}
...
我们将不断调整优化玩法，使得Musicube的操作更加流畅、体验更加出色。
\subsection{玩家可编辑图谱}
\paragraph{}
开源社区是慢慢流行起来的一种代码管理开发方式，音乐游戏也能做到开源的效果。Musicube将为玩家提供一个谱面编辑器，能让玩家用自己想用的歌曲随意进行谱面的制作。
...
这个技术需求是针对游戏机制的。音乐游戏在判定上较为严格并且有不同level的打击判定。长音符和短音符在操作和打击判定上也有比较大的区别。如何设计实现适合Musicube的打击判定机制也是一个技术难点。在编辑器方面，由于编辑谱面需要时间轴，操作判定节点、音乐三者结合，并且我们没有相关编辑器的开发经验，因此这个编辑器的实现有较大的技术风险。
\paragraph{}
\textbf{音乐游戏的特效}
